...
"(Сделан по мотивам RISO KAGAKU Webmail Notifier)\r\n"
"\r\n"
...
"\r\n"
"Чтобы изменить настройки, достаточно вписать новое значение в соответствующий файл, после чего нажать и удерживать кнопку SETUP. Короткое нажатие приведет просто к переподключению устройства в рабочем режиме (без \"флешки\").\r\n"
"\r\n"
...
"Помимо \"родного\" софта, можно напрямую писать в /sys/class/leds/riso_kagaku3\\:blue/brightness и подобные. Правда, по умолчанию, только от рута.\r\n"
"\r\n"
"Текстовый дисплей\r\n"
...
"Автор: COKPOWEHEU\r\n"
;
#warning: допилить рулез чтобы писать в /sys/class можно было не от рута
