...
#define LCD_HELP3 \
  ...
  "  \\e[J , \\e[0J - Очистить дисплей от курсора до конца экрана\r\n" \
  "  \\e[1J    - Очистить дисплей от начала экрана до курсора\r\n" \
  "  \\e[2J    - Очистить дисплей полностью и переместить курсор в (1,1)\r\n" \
